...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btnScrollToTop.addEventListener("click", function () {
    // Llama a la función para hacer scroll al principio
    scrollToTop();
  });

  // Función para hacer scroll al principio de la página
  function scrollToTop() {
    // Utiliza el método scrollTo para hacer scroll al principio
    window.scrollTo({
      top: 0,
  ...
  // Puedes agregar más lógica o ajustes según sea necesario
});
